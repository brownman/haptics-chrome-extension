...
NPError NPP_New(NPMIMEType mime_type,
  ...
  instance->pdata = haptics_service;
...
NPError NPP_Destroy(NPP instance, NPSavedData** save) {
  ...
  HapticsService* haptics_service = static_cast<HapticsService*>(instance->pdata);
  if (haptics_service != NULL) {
    delete haptics_service;
  }
  return NPERR_NO_ERROR;
}
...
NPObject* NPP_GetScriptableInstance(NPP instance) {
  ...
  HapticsService* haptics_service = static_cast<HapticsService*>(instance->pdata);
  if (haptics_service) {
    object = haptics_service->GetScriptableObject();
  }
  return object;
}
